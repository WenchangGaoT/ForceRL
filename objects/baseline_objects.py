...
class BaselineEvalRevoluteObjects(MujocoXMLObject):
    """
    Sample Objects with revolute joints (used in baseline Eval)
    Args:
        name (str): Name of the object
    """
...
class BaselineEvalPrismaticObjects(MujocoXMLObject):
    '''
    Sample Objects with prismatic joints (used in baseline Eval)
    '''
    def __init__(self, name,scaled = False, scale = 1.0):
