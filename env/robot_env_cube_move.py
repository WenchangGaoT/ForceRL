...
class RobotCubeMove(SingleArmEnv):
    ...
    def _setup_observables(self):
        ...
        if self.use_object_obs:
            ...
            sensors = [cube_pos, cube_quat, gripper_to_cube_pos, gripper_pos]
    ...
    def _check_success(self):
        ...
        """
        # pos_index = self.robots[0]._ref_gripper_joint_pos_indexes
        # eef_pos = [self.sim.data.body_xpos[x] for x in pos_index]
