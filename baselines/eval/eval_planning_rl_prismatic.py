...
def eval_prismatic(experiment_name, run_id, object_type="cabinet", success_threshold=0.7):
    ...
    video_path = os.path.join(video_dir, f"test_{training_exp_name}_fail.mp4")
    ...
    for obj_name in available_objects:
        ...
        for exp_num in range(trials_per_object):
            ...
            # print(env._get_observations()["joint_direction"])
...
if __name__ == "__main__":
    ...
    for i in range(10):
        eval_prismatic(experiment_name, i, object_type=object_type, success_threshold=success_threshold)
        delete_camera_frame_grasp_proposals()
        time.sleep(1)