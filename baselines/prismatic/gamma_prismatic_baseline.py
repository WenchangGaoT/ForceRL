...
for i in range(200):
    ...
    # normalize the vertical direction
    action_dir = joint_direction_selected / np.linalg.norm(joint_direction_selected) * 0.05

    action = np.concatenate([last_grasp_pos + action_dir, rotation_vector, [1]])
